...
class DINetTrainingOptions():
    ...
    def parse_args(self):
        ...
        self.parser.add_argument('--lr_d', type=float, default=0.0005, help='initial learning rate for adam')
        ...
        self.parser.add_argument('--checkpoint', type=int, default=600, help='num of checkpoints in training stage')
